...
<html lang="ar" dir="rtl">
    ...
    <body class="bg-gray-100 selection:bg-white selection:text-[var(--secondary)]">
        <nav class="bg-[var(--primary)] mb-16">
        ...
        <footer class="bg-[var(--primary)] text-white mt-16">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between mx-20">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li><a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300">الرئيسية</a></li>
                                <li><a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300">حول عطاء</a></li>
                                <li><a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300">اتصل بنا</a></li>
                                <li><a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300">الأسئلة الشائعة</a></li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-white  font-medium">
                                <li class="mb-4">
                                    <a href="https://github.com/abdulqdos" class="text-white hover:text-[var(--gold)] tranisiton duration-300">Github</a>
                                </li>
                                <li>
                                    <a href="https://www.instagram.com/x._3bdo_.x/" class="text-white hover:text-[var(--gold)] tranisiton duration-300">instagram</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-white font-medium">
                                <li class="mb-4">
                                    <a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300" >سياسة الخصوصية</a>
                                </li>
                                <li>
                                    <a href="#" class="text-white hover:text-[var(--gold)] tranisiton duration-300">الشروط والأحكام</a>
                                </li>
                ...
                <div class="sm:flex sm:items-center sm:justify-between mx-20">
                    <span class="text-sm text-white sm:text-center ">© 2023 <a href="https://flowbite.com/" class="hover:underline">Ataa™</a>. All Rights Reserved.
          </span>
                    <div class="flex mt-4 sm:justify-center sm:mt-0 hover:text-[var(--gold)] tranisiton duration-300">
                        <a href="https://www.facebook.com/profile.php?id=100013918442051" class="text-white hover:text-[var(--gold)] tranisiton duration-300">
                            <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                                <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                            </svg>
                            <span class="sr-only">Facebook page</span>
                        </a>
                        <a href="#" class="text-white   ms-5 hover:text-[var(--gold)] tranisiton duration-300">
                        ...
                        <a href="https://github.com/abdulqdos" class="text-white  ms-5 hover:text-[var(--gold)] tranisiton duration-300">
                        ...
                        <a href="https://www.instagram.com/x._3bdo_.x/" class="text-white  ms-5 hover:text-[var(--gold)] tranisiton duration-300">
