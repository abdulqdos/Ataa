<div>
    ...
    <x-layouts.header title="إدارة المتطوعون"
                      :breadcrumbs="[['الرئيسية', route('organization.dashboard')], ['المتطوعون']]">
    </x-layouts.header>
            ...
            @else
                        ...
                        <div class="bg-primary/10 border-l-4 border-secondaryLight p-4 mb-4">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p class="text-primary/90">لم يتم العثور على متطوعين بإسم "{{ $searchText }}"</p>
                                </div>
                            </div>
                ...
                @else
                    ...
                    <div class="bg-primary/20 border border-secondaryLight rounded-xl p-6 text-center">
                        ...
                        <h3 class="mt-3 text-lg font-medium text-gray-800">لا توجد متطوعون مسجلين</h3>
                        <p class="mt-1 text-sm text-gray-600">لا يوجد متطوعين في مؤسستك حاليا. يمكنك إضافة متطوعين الآن.</p>
                        <div class="mt-4">
                            <a href="#" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md btn-primary">
                                ...
                                <span class="mr-2"> إضافة متطوعين </span>
                            </a>
                        </div>
                    </div>
                @endif
