<div class="flex items-center justify-center mx-auto bg-gray-200 ">
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm mx-auto  min-w-96 my-[10%]">
        <div class="p-4 sm:p-7">
            <div class="text-center">
                <h1 class="block text-2xl font-bold text-[var(--primary)]"> نسيت كلمة المرور </h1>
                @if (session()->has('message'))
                    <div class="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 my-4" role="alert">
