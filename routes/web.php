...
use App\Livewire\Organization\Requests\RequestsOpportunities as RequestIndex;
...
Route::middleware('organization')->group(function () {
    ...
    // Requests
    Route::get('/organization/requests' , RequestIndex::class)->name('organization.requests');
