...
namespace App\Livewire\Organization\Volunteers\Documentation;
...
{
    use withFileUploads ;
    public $description , $hours , $participation_date , $report , $eval_commitment , $eval_teamwork , $eval_leadership , $opportunity , $volunteer , $certificate_path , $certificate ;

    public function mount(Opportunity $opportunity ,Volunteer $volunteer)
    {
    ...
    public function store()
    {
        ...
        return redirect(route('organization.volunteers' , $this->opportunity->id))->with('success' , 'تم توثيق نشاط المتطوع بنجاح');
    }

    public function render()
    {
        return view('livewire.organization.volunteers.documentation.create');
    }
}
