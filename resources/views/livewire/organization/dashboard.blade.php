                ...
                <div class="p-4">
                    <ul>
                        ...
                        <li class="flex items-center py-3 border-b border-gray-100">
                            ...
                            <span class="text-xs text-white bg-primary rounded-full px-2 py-1">12 ساعة تطوع</span>
                        </li>
                        <li class="flex items-center py-3 border-b border-gray-100">
                            ...
                            <span class="text-xs text-white bg-primary rounded-full px-2 py-1">8 ساعات تطوع</span>
                        </li>
                        <li class="flex items-center py-3">
                            ...
                            <span class="text-xs text-white bg-primary rounded-full px-2 py-1">15 ساعة تطوع</span>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="p-4">
                    <ul>
                        <li class="flex items-center py-3 border-b border-gray-100">
                            ...
                            <div>
                                <button class="px-3 py-1 btn-primary  text-xs  ml-1">قبول</button>
                                <button class="px-3 py-1 btn-secondary  text-xs">رفض</button>
                            </div>
                        </li>
                        <li class="flex items-center py-3 border-b border-gray-100">
