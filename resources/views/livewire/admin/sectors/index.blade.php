        ...
        <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="space-y-2">
                ...
                <p class="text-xs text-gray-500">
                    ابدأ بكتابة اسم القطاع للبحث المباشر
                </p>
            </div>
        </div>
                        ...
                        <div class="bg-white shadow-sm rounded-md  overflow-hidden border border-gray-100  transition-shadow duration-300">
                            <div class="p-5 space-y-4">
                                <div class="flex flex-row justify-between items-start">
                                    ...
                                    <button class="text-gray-400 hover:text-primary transition-colors duration-200 p-1 cursor-pointer">
                                ...
                                <div class="pt-4 flex space-x-3">
                                    ...
                                    <button wire:click="editSector({{ $sector->id }})"
                                     ...
                                     text-primary bg-white border border-primary hover:bg-gray-50
                                    transition-all duration-300 flex gap-2 items-center justify-center cursor-pointer">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                        </svg>
                                        تعديل
                    ...
                    <div class="bg-primary/10 border-l-4 border-secondaryLight p-4 mb-4">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-primary/90">لم يتم العثور على قطاعات بإسم"{{ $searchText }}"</p>
                            </div>
                        </div>
