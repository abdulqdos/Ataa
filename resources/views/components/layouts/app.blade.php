...
<nav class="bg-gray-800">
    <!-- جميع الأجهزة باستثناء الهاتف -->
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 hidden lg:block">
        <div class="relative flex h-16 items-center justify-between">

            <!-- الشعار في منتصف الشاشة على الهواتف -->
            ...
            <!-- روابط القائمة في المنتصف على الشاشات الكبيرة -->
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-center mr-20">
            ...
            <!-- زر الملف الشخصي في الجهة اليسرى -->
