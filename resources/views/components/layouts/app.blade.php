            ...
            <div class="flex justify-between h-16">
                ...
                @guest
                    ...
                    <div id="guestView" class="hidden sm:flex sm:items-center sm:mr-6">
                        <a href="{{ route('login') }}" class="text-gray-600 hover:text-[var(--primary)] px-3 py-2 rounded-md text-sm font-medium transition duration-300">تسجيل الدخول</a>
                        <a href="{{ route('signup') }}" class="bg-[var(--primary)] text-white hover:bg-[var(--primaryLight)] px-4 py-2 rounded-md text-sm font-medium transition duration-300">إنشاء حساب</a>
                    </div>
                @endguest
                ...
                <div class="flex items-center sm:hidden">
                    <button type="button" id="mobileMenuButton" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-inset focus:ring-[var(--primary)]" aria-controls="mobile-menu" aria-expanded="false">
...
<!-- Footer -->
    <footer class="bg-[var(--primary)]">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <div class="mt-8">
                        ...
                        <form class="mt-2 flex flex-col">
                            <input type="email" class="px-4 py-2 rounded-md w-full bg-white placeholder-text-[var(--secondary)] focus:outline-none" placeholder="البريد الإلكتروني">
                            <button type="submit" class="mt-2 bg-[var(--secondary)] text-white py-2 px-4 rounded-md hover:bg-[var(--secondaryLight)]">
                                اشترك الآن
                            </button>
                        </form>
                    </div>
            ...
            <div class="mt-8 border-t border-[var(--secondary)] pt-8">
